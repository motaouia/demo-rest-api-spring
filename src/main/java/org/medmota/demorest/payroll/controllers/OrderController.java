...
import org.medmota.demorest.payroll.assembllers.OrderModelAssembler;
import org.medmota.demorest.payroll.exceptions.OrderNotFoundException;
...
public class OrderController {
	...
	@GetMapping("/orders")
	public CollectionModel<EntityModel<Order>> listAllOrders() {
		List<EntityModel<Order>> orders = orderRepository.findAll().stream() //
				.map(assembler::toModel) //
				.collect(Collectors.toList());

		return CollectionModel.of(orders, //
				linkTo(methodOn(OrderController.class).listAllOrders()).withSelfRel());
